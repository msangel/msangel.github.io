---
title: Основы работы с GnuPG, администрирование ключей
...
```
Из ответа мы узнали о версии программы, поддерживаемых алгоритмах шифрования и компрессии и о месте, где все ключи будут храниться. К слову, это место можно изменить, установив переменную окружения GNUPGHOME(`export GNUPGHOME=/path/to/the/folder`)
...
Теперь, об вс встречаемых далее аббревиатурах:
```text
sec => 'SECret key'
ssb => 'Secret SuBkey'
pub => 'PUBlic key'
...
![GPA](https://k.co.ua/resources/pgp/Screenshot_2021-10-17_17-56-40.png)
