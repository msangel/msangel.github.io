...
todo: add image legends
{:.no_toc}
# {{ page.title }}
{: style='text-decoration: underline; margin-bottom: 20px; color: #222222;' }
...
![Matrix of hell](https://k.co.ua/resources/docker/the_matrix_of_hell.png "Matrix of hell"){: .col-xs-12 .col-sm-10 .col-sm-offset-1 .col-md-8 .col-md-offset-2}
{: .row}
...
![Matrix solved](https://k.co.ua/resources/docker/the_matrix_of_hell_solved.png "Matrix solved"){: .col-xs-12 .col-sm-10 .col-sm-offset-1 .col-md-8 .col-md-offset-2}
{: .row}
...
![Hypervisor types](https://k.co.ua/resources/docker/hypervisor.png "Hypervisor types"){: .col-xs-12 .col-sm-10 .col-sm-offset-1 .col-md-8 .col-md-offset-2}
{: .row}
...
![VM vs Container](https://k.co.ua/resources/docker/vm_vs_container.png "VM vs Container"){: .col-xs-12 .col-sm-10 .col-sm-offset-1 .col-md-8 .col-md-offset-2}
{: .row}
...
![Docker use](https://k.co.ua/resources/docker/docker_use.png "Docker use"){: .col-xs-12 .col-sm-10 .col-sm-offset-1 .col-md-8 .col-md-offset-2}
{: .row}

The mentined above "Union File sysytem" built on top of   "Copy-On-Write" principle and allows hight reuse of file systems.

![Union File System](https://k.co.ua/resources/docker/copy_on_write_fs.png "Union File System"){: .col-xs-12 .col-sm-10 .col-sm-offset-1 .col-md-8 .col-md-offset-2}
{: .row}
