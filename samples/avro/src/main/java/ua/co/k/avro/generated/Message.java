...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4980046846726651199L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"ua.co.k.avro.generated\",\"fields\":[{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"body\",\"type\":\"string\"}]}");
   ...
   */
  public static ua.co.k.avro.generated.Message.Builder newBuilder() {
    return new ua.co.k.avro.generated.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static ua.co.k.avro.generated.Message.Builder newBuilder(ua.co.k.avro.generated.Message.Builder other) {
    if (other == null) {
      return new ua.co.k.avro.generated.Message.Builder();
    } else {
      return new ua.co.k.avro.generated.Message.Builder(other);
    }
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static ua.co.k.avro.generated.Message.Builder newBuilder(ua.co.k.avro.generated.Message other) {
    if (other == null) {
      return new ua.co.k.avro.generated.Message.Builder();
    } else {
      return new ua.co.k.avro.generated.Message.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ua.co.k.avro.generated.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ua.co.k.avro.generated.Message other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.to)) {
        this.to = data().deepCopy(fields()[0].schema(), other.to);
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.co.k.avro.generated.Message.Builder setTo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.co.k.avro.generated.Message.Builder clearTo() {
      to = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.co.k.avro.generated.Message.Builder setFrom(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.co.k.avro.generated.Message.Builder clearFrom() {
      from = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.co.k.avro.generated.Message.Builder setBody(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ua.co.k.avro.generated.Message.Builder clearBody() {
      body = null;
