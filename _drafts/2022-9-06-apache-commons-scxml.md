...
* NFA with ε-moves: ну і недетермінований з переходами без вхідного символу (події) [пояснення](https://www.tutorialspoint.com/explain-nfa-with-epsilon-transition#)
